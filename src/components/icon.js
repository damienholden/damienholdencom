...
const Icon = props => {
  const fill = props.color === "dark" ? "#000000" : "#ffffff";
  return (
  <svg className={classNames(iconStyles.icon, props.icon)}
  focusable="false" viewBox="0 0 24 24" aria-hidden="true" fill={fill}>
